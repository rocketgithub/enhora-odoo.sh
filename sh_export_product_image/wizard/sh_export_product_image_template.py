...
class ShExportProductImageTmpl(models.TransientModel):
    ...
    product_tmpl_ids = fields.Many2many(
        'product.template', string='Products', store=False)
    ...
    def default_get(self, fields):
        rec = super(ShExportProductImageTmpl, self).default_get(fields)
